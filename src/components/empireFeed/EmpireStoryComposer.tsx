 ...
 *  same pattern as EmpirePostComposer/ListCar.tsx) and manage existing
 *  ones (active + expired, with view counts and delete) — kept as one
 *  sheet with two views rather than a separate admin-dashboard route,
 *  so management stays integrated into the Empire experience itself. */
export function EmpireStoryComposer({ onClose, onPublished }: { onClose: () => void; onPublished: () => void }) {
