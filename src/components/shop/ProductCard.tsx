          ...
          <div className="p-4">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <h3 className="truncate text-copy font-medium text-ink">{product.name}</h3>
                <p className="mt-0.5 truncate text-detail text-muted">{product.tagline}</p>
              </div>
            </div>

            <div className="mt-2 flex items-center gap-1 text-caption text-muted">
            ...
            <div className="mt-3.5 flex items-end justify-between border-t border-line pt-3.5">
              <p className="text-ink">
                <span className="text-lead font-semibold">{eur(product.price)}</span>
              ...
              <button
                ...
                className="pressable inline-flex items-center gap-1.5 rounded-full bg-ink px-3.5 py-2 text-caption font-semibold text-white transition-colors hover:bg-black"
              >
